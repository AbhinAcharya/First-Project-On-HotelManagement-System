	...
	<div class="maindiv">
		...
		<div class="bodydiv_gallery">
			<div class="div_social_gallery">
				<a href="https://www.facebook.com/acharya.thechallengerboy"><img src="../img_src/fb.jpeg" class="img_social"></a>
			...
			<?php 
				...
				{ $con=mysqli_connect("localhost","root","","Deerfieldlodge") or die("connection couldn't be established");
					...
					<?php echo "Price: "; echo $record['price'];?><br> <?php
					echo "Description:";?><br><?php echo $record['description'];?>
					<?php if (isset($_SESSION['userid'])):?>
					<a href="../database/database.php?book_roomno=<?php echo $record['roomno']; ?>&userid=<?php echo $_SESSION['userid'];?>">Book Now</a><?php endif?>
					<?php
...
<img src="../img_src/<?php echo $row['imagename']?>" class="img_gallery image_fade" title="<?php echo $row['imagename']?>">
		...
		<br>
		Price: <?php echo $row['price']?><br><br><br>
